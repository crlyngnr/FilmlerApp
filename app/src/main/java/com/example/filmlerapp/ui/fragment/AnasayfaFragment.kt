...
class AnasayfaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.recyclerViewFilmler.layoutManager = StaggeredGridLayoutManager(2,StaggeredGridLayoutManager.VERTICAL)
        ...
        binding.recyclerViewFilmler.adapter = filmlerAdapter
